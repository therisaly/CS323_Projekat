...
class Model {
  ...
  public:
    ...
    void load(const char *filename) {
        ...
        //The position of the model is calculated by averaging the vertices'
        //coordinates and adjusting for the model's center.
        //This ensures that the model is centered when rendered.
